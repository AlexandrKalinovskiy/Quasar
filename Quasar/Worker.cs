...
namespace Quasar
{
    public class Worker
    {
        ...
        public void Scanner(int useThreads)
        {
            ...
            Func<object, IQFeedTrader, int> func = new Func<object, IQFeedTrader, int>(RunStrategy);
            ...
            if (tradersCollection.Count == 0)
            {
                for (int i = 0; i < securitiesCount; i++)
                {
                    ...
                    if (securitiesStake.Count == stakeSize)
                    {
                        ...
                        asyncResult = func.BeginInvoke(securitiesStake, trader, null, null);
        ...
        public int RunStrategy(object obj, IQFeedTrader trader)
        {
